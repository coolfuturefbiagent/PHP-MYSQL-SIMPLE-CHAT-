	...
	Croppic.prototype = {
		...
		bindImgUploadControl: function(){
			...
			if( !$.isEmptyObject(that.croppedImg)){
				...
				$("#img_url_0").val("");$(".cropContainerMinimal_imgUploadForm").remove();
...
$("#profilesettingsform").append('<input type="hidden" id="img_url_1" name="cropped_img_url" value="' + response.url + '">');
				that.obj.append(img);
		...
		createCropControls: function(){
			...
			that.cropControlReset.on('click',function(){ that.reset();$("#img_url_1").val("");$("#img_url_0").val(""); });				
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.destroy();
				$("#cropContainerMinimal").html("");
                $("#cropContainerMinimal").html('<img class="croppedImg" src="' + response.url + '">');
				$("#profilesettingsform").append('<input type="hidden" id="img_url_0"name="cropped_img_url" value="' + response.url + '">');
